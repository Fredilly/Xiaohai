...
export const demoBooks: DemoBook[] = [
  { title: '森林里的小邮局', author: '小海编辑部', price: '¥39.00', note: 'Demo 图书 · 非真实商品' },
  { title: '星星落在书页上', author: '胖竹童书', price: '¥45.00', note: 'Demo 图书 · 非真实商品' },
  { title: '今天也要好好长大', author: '小海编辑部', price: '¥32.00', note: 'Demo 图书 · 非真实商品' },
];

export const demoStores: DemoStore[] = [
  { name: '胖竹书店 · 示例门店 A', city: '成都', services: '阅读 · 自习 · 活动', note: 'Frontend demo，不代表真实门店/库存' },
  { name: '胖竹书店 · 示例门店 B', city: '示例城市', services: '图书 · 租借 · 自提', note: 'Frontend demo，不代表真实营业信息' },
];
